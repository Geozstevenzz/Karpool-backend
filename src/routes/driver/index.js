...
const { createTripHandler, acceptPassengerReq, registerVehicle, rejectPassengerReq, tripCompleted, getTripRequests, tripStart, uploadVehiclePicture } = require("../../controllers/driverController");
